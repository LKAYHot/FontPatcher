...
export const INITIAL_CONFIG = {
  ...
  jobsFile: '',
  maxWorkers: 1,
  continueOnJobError: false,
  unityPath: 'C:/Program Files/Unity/Hub/Editor/2022.3.10f1/Editor/Unity.exe',
  unityHubPath: 'C:/Program Files/Unity Hub/Unity Hub.exe',
  unityVersion: '2022.3.10f1',
  targetGame: '',
  unityInstallRoot: 'C:/UnityInstallations',
  epoch: 'auto',
  useNographics: true,
  ...
  atlasSizes: '1024,2048,4096',
  pointSize: 90,
  padding: 8,
  scanUpperBound: 1114111,
  forceStatic: false,
  forceDynamic: false,
  dynamicWarmupLimit: 20000,
  dynamicWarmupBatch: 1024,
